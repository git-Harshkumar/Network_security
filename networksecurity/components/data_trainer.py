...
class ModelTrainer:
    ...
    def track_mlflow(self,best_model, classificationmetric, model_name):
        ...
        with mlflow.start_run():
            ...
            try:
                ...
                logging.warning(
                    f"Model registry registration failed: {registry_error}. Logging model locally instead."
                )
    ...
    def train_model(self,X_train,y_train,x_test,y_test):
        ...
        self.track_mlflow(best_model, classification_train_metric, model_name)
        ...
        self.track_mlflow(best_model, classification_test_metric, model_name)
    ...
    def initiate_model_trainer(self)->ModelTrainerArtifact:
        try:
            ...
            #loding training and testing array 
